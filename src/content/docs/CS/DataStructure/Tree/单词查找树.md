...
![](https://cdn.nlark.com/yuque/0/2021/jpeg/262797/1610333683951-0b82f321-0f5a-4862-ad78-fe8045ce39f4.jpeg#align=left&display=inline&height=416&originHeight=416&originWidth=358&size=0&status=done&style=none&width=358)
...
2. 从根节点到某个节点的路径连接起来时，就是一个完整的字符串
   ![](https://cdn.nlark.com/yuque/0/2021/jpeg/262797/1610333683962-3cfb692c-ad55-4ddf-af13-c7bb28181cc2.jpeg#align=left&display=inline&height=416&originHeight=416&originWidth=360&size=0&status=done&style=none&width=360)
   如上图所示，整个路径连一起为字符串 "tree"
3. 每个节点的子节点所包含在*字符唯一*。不会出现一下情况
   ![](https://cdn.nlark.com/yuque/0/2021/jpeg/262797/1610333683966-67299a9c-e904-4036-bf3f-f537ad1c82af.jpeg#align=left&display=inline&height=220&originHeight=220&originWidth=274&size=0&status=done&style=none&width=274)
4. 每个节点都存在 R 条链接，R 为字符的范围。举个例子，如果是 ASCII 编码，则 R 为 256。R 向单词查找树可能会存在很多的空键，所以在绘制时一般忽略空键。示意图如下所示

![](https://cdn.nlark.com/yuque/0/2021/jpeg/262797/1610333683980-139d6046-9359-4a47-8a8a-28fefa288bba.jpeg#align=left&display=inline&height=390&originHeight=390&originWidth=1144&size=0&status=done&style=none&width=1144)
...
2. 查找未命中只需要查找若干个字符，M 为未命中所需要查询的次数（M<=L），未命中平均查找字符数为 $\log_R{N}$《算法 4 有证明》
   ![](https://cdn.nlark.com/yuque/0/2021/jpeg/262797/1610333683996-c3c4a898-df2e-4df6-8c48-ff58782a377f.jpeg#align=left&display=inline&height=418&originHeight=418&originWidth=388&size=0&status=done&style=none&width=388)
...
![](https://cdn.nlark.com/yuque/0/2021/jpeg/262797/1610333683994-e6e27f58-fe56-45f6-8bff-f5027bf86a6a.jpeg#align=left&display=inline&height=418&originHeight=418&originWidth=388&size=0&status=done&style=none&width=388)
...
![](https://cdn.nlark.com/yuque/0/2021/jpeg/262797/1610333683989-d4b189ac-c908-4f81-9374-85efa46f786a.jpeg#align=left&display=inline&height=746&originHeight=746&originWidth=732&size=0&status=done&style=none&width=732)
