...
![](https://cdn.nlark.com/yuque/0/2020/png/262797/1609314174237-bc996185-e589-4c0b-a25b-a83c0f2b21bd.png#align=left&display=inline&height=723&originHeight=723&originWidth=1200&size=0&status=done&style=none&width=1200)
...
例如常用的 URL 地址 "[http://www.baidu.com](http://www.baidu.com)"
...
[留一个面试题，纯前端如何将 `{ name: "我", age: 12 }` 下载为一个 user.json 文件](https://www.yuque.com/yuezhiming/oszqqs/ag5q8s#aWanw)
