...
![image.png](https://cdn.nlark.com/yuque/0/2020/png/262797/1609316657913-b650c84b-8bff-4156-84a1-a4581b22658a.png#height=312&id=bBPqZ&originHeight=624&originWidth=1568&originalType=binary&ratio=1&size=101992&status=done&style=none&width=784)
...
![image.png](https://cdn.nlark.com/yuque/0/2020/png/262797/1609316342173-b4881f4e-8237-40a3-aad0-c2ff3e54f4b9.png#height=550&id=MY1sN&originHeight=1100&originWidth=1570&originalType=binary&ratio=1&size=229208&status=done&style=none&width=785)
设置 sharding.clusterRole 需要 mongod 实例运行复制。 要将实例部署为副本集成员，请使用 replication.replSetName 设置并指定副本集的名称
...
如无特殊情况，一般推荐使用 Hash Sharding，一般都可以选择\_id 作为 Key
