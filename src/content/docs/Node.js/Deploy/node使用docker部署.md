...
![](https://public.keven.work/docker-size.png#id=FPtwe&originHeight=20&originWidth=832&originalType=binary&ratio=1&status=done&style=none)
...
![](https://public.keven.work/docker-size.png#id=TosM7&originHeight=20&originWidth=832&originalType=binary&ratio=1&status=done&style=none)
...
这是优化后的大小
![](https://public.keven.work/docker-size-small.png#id=NPUAB&originalType=binary&ratio=1&status=done&style=none)
